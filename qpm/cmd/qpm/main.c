...
int run_init(void) {
    char _qpm_name[256]; qpm_cwd_base(_qpm_name, 256);
    manifest_clear(); manifest_set_name(_qpm_name); manifest_set_version("0.1.0"); manifest_set_main("main.qsc");
